...
const createNewOrderColumn = (orderIdInput) => {
	...
	let cardOrderStatusText = document.createTextNode('ORDER NO ALREADY EXISTS')
...
//!-- ----------------------------- Chocolate Donut -----------------------------//
const createNewOrderDonut = (orderIdInput) => {
	let colDiv = document.createElement('div')
	let cardDiv = document.createElement('div')
	let cardHeaderDiv = document.createElement('div')
	let cardBodyDiv = document.createElement('div')
	...
	let cardHeaderDivText = document.createTextNode('Order ID: ' + orderIdInput)
	let cardTitleH5Text = document.createTextNode('Bill Amount: $127')
	let cardTextPText = document.createTextNode('Chocolate Donut - 2 Nos')
	let cardButtonAText = document.createTextNode('Cancel Order')
	let cardOrderStatusText = document.createTextNode('ORDER NO ALREADY EXISTS')
...
const createNewOrderChickenStrips = (orderIdInput) => {
	let colDiv = document.createElement('div')
	let cardDiv = document.createElement('div')
	let cardHeaderDiv = document.createElement('div')
	let cardBodyDiv = document.createElement('div')
	...
	let cardHeaderDivText = document.createTextNode('Order ID: ' + orderIdInput)
	let cardTitleH5Text = document.createTextNode('Bill Amount: $148')
	let cardTextPText = document.createTextNode('Chicken Strip Box - 1 Nos')
	let cardButtonAText = document.createTextNode('Cancel Order')
	let cardOrderStatusText = document.createTextNode('ORDER NO ALREADY EXISTS')
...
//-- --------------- Chicken Strip Basket --------------- --//
const createNewOrderFrenchFries = (orderIdInput) => {
	let colDiv = document.createElement('div')
	let cardDiv = document.createElement('div')
	let cardHeaderDiv = document.createElement('div')
	let cardBodyDiv = document.createElement('div')
	...
	let cardHeaderDivText = document.createTextNode('Order ID: ' + orderIdInput)
	let cardTitleH5Text = document.createTextNode('Bill Amount: $42')
	let cardTextPText = document.createTextNode('FrenchFries - 1 Nos')
	let cardButtonAText = document.createTextNode('Cancel Order')
	let cardOrderStatusText = document.createTextNode('ORDER NO ALREADY EXISTS')
